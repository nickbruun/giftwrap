...
class Package(object):
    ...
    :ivar name: Package name. Must consist only of lower case letters (a-z), 
    digits (0-9), plus (+) and minus (-) signs, and periods (.). They must be 
    ...
    :ivar description: Short, one-line description. Keep short and concise, 
    and do not start with the package name.
    :ivar long_description: Longer description not starting with the package 
    name.
    :ivar version: Package version.
    :ivar depends: Dependencies of the package.
    :ivar architectures: Package architecture(s) as a list or tuple of 
    architectures.
    :ivar section: Package section. Specifies an application area into which 
    ...
    def __init__(self, 
        ...
        :ivar name: Package name. Must consist only of lower case letters 
        ...
        :ivar description: Short, one-line description. Keep short and concise, 
        and do not start with the package name.
        :ivar long_description: Longer description not starting with the 
        package name.
        :ivar version: Package version.
        :param depends: default [], Packages on which the package depends as 
        either a list or tuple.
        :param architecture: default ``None``, Package architecture(s) as a 
        list or tuple of architectures. If ``None`` is supplied, the current 
        system architecture will be used.
        :param section: default ``SECTION_WEB``, Package section. Specifies an 
        ...
        self.copyright = 'Copyright %d %s <%s>' % (datetime.datetime.utcnow().year, 
